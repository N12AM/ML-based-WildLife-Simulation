...
public class PredatorBehavior : Agent
{
    [SerializeField] private Transform preyTransform;
    ...
    public override void OnEpisodeBegin()
    {
        ...
        preyTransform.localPosition = new Vector3(Random.value * 8 -4, 0.5f, Random.value * 8 - 4);
    }
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        float distanceToTarget =
            Vector3.Distance( this.transform.localPosition,preyTransform.localPosition);
